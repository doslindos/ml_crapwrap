from .tf_layer_functions import create_weights, create_bias, dense_layer, conv_layer, recurrent_layer
...
class Layer_Handler:
    ...
    def initialize_dense_layer(self, conf, weights, bias, transpose):
    ...
    def initialize_conv_layer(self, conf, weights, bias, transpose):
    ...
    def Dense(  self,
        ...
        # Initialize layers
        weights, bias = self.initialize_dense_layer(conf, weights, bias, transpose)
        ...
        for layer, w in enumerate(ws):
            ...
            shapes[layer]['OUT'] = x.numpy().shape
    ...
    def Convo(self,
        ...
        # Initialize layers
        weights, bias = self.initialize_conv_layer(conf, weights, bias, transpose)
